...
export default function authenticate(state = { userData: [{name: 'admin', email: 'admin@g.com', password: '12345678', confirmPassword: '12345678', id: 1}], authenticateUser: null }, action) {
    switch (action.type) {
